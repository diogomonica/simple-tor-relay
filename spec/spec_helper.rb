...
require File.expand_path("../../spec/support/fake_digitalocean.rb", __FILE__)
...
RSpec.configure do |config|
  ...
  config.before(:each) do
    ...
    stub_request(:post, "https://cloud.digitalocean.com/v1/oauth/token").
      to_return(:status => 200, :body => {access_token: "FAKE_TOKEN"}.to_json)
